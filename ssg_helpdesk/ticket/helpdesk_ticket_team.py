...
class HelpdeskTicketTeam(common.SavepointCase):
    @classmethod
    def setUpClass(cls):
        super(HelpdeskTicketTeam, cls).setUpClass()
    ...
    def helpdesk_ticket_team_from_category(self):
        self.assertEqual(
            self.team_id.todo_ticket_count,
            2,
        )
        category = self.env.ref("ssg_helpdesk.helpdesk_category_1")
